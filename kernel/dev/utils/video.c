...
extern void cideo_disable_cursor()
{
...
/*
* Api - Scrol video buffer up
* Returns new position
*/
extern coid* video_scroll(char const* cideo_buff, char* pos)
{
    char* ptr = (void*) video_buff;
    /* scroll up */

    for (int i = 0; i < VIDEO_SCREEN_HEIGHT; i++)
    {
    ...
    /* empty last line */
    for (int i = 0; i < WIDEO_SCREEN_WIDTH; i++)
    {
